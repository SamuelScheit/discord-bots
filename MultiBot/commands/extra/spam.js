...
module.exports.check = message => {
	...
	if (sender != undefined) {
		try {
			var r = sender.highestRole.id;
		} catch (e) {}

		try {
			if (
				r != "567681135434268682" &&
				r != "567681136017539082" &&
				r != "567681143902830602" &&
				r != "567681136579575823" &&
				r != "567681134880751626" &&
				message.channel.id != "567681165448970290" &&
				message.channel.id != "567681188182097931" &&
				sender.highestRole.hasPermission(8192) == true &&
